...
export default function ThemeToggle(): JSX.Element {
  ...
  // Move all client-side logic to useEffect to avoid hydration mismatch
  useEffect(() => {
    try {
  ...
  return (
    ...
    >
      ...
      {isDark ? (
        <svg className="h-4 w-4 text-yellow-400" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        ...
        <svg className="h-4 w-4 text-foreground/80" viewBox="0 0 24 24" fill="none" aria-hidden="true">
